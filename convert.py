...
SRC_FN = os.path.join(THIS_DIR,  'sources', 'register.txt')
OUT_FN = os.path.join(THIS_DIR, 'out', 'register.xml')
    ...
    for l in open(SRC_FN).readlines():
        ...
        for page in _pages:
            if page.isdigit():
                ...
                print l
                print page
                raise Exception('Did not recognaize %s as a valid page reference' % page)
